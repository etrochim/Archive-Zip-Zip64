...
use constant ZIP64_END_OF_CENTRAL_DIRECTORY_SIGNATURE_STRING =>
    pack( "V", ZIP64_END_OF_CENTRAL_DIRECTORY_SIGNATURE );
use constant ZIP64_END_OF_CENTRAL_DIRECTORY_FORMAT => "V V2 v2 V10";
use constant ZIP64_END_OF_CENTRAL_DIRECTORY_LENGTH => 52;
